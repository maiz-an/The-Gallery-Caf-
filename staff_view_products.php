...
// Query to select products by id
...
<body>
    ...
    <section>
        <div class="view-products-container">
            <a href="staff_add_menu.php" class="cart-view">Add Products</a>
            ...
            <table id="productsTable">
                ...
                if (mysqli_num_rows($result) > 0) {
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo '<td>';
                        echo '<a href="staff_edit_product.php?id=' . $row['id'] . '"class="delete-btn">Edit</a> <br><br><br>  ';
                        echo '<a href="staff_delete_product.php?id=' . $row['id'] . '"class="delete-btn" onclick="return confirm(\'Are you sure you want to delete this product?\')">Delete</a>';
                        echo '</td>';
                        echo "</tr>";
                    }
                } else {
