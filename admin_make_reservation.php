...
<head>
    ...
    <title>Make Reservation - Admin</title>
...
<body>
            ...
            <div class="title-nav">
                <nav>
                    <ul>
                        ...
                        <li><a href="admin_manage_reservations.php" class="nav-btn" style="color: #ffcc00;">Reservation</a></li>
    ...
    <main>
        <div class="form-container">
            <a href="admin_manage_reservations.php" class="cart-link">View</a>
            ...
            <form method="post">
                ...
                <input type="number" id="num_people" name="num_people" min="1" max="20" required>

                <label for="parking_slot">Parking Slot</label>
                <input type="number" id="parking_slot" name="parking_slot" min="1" max="10" required>
    ...
    <?php if ($reservation_success) : ?>
        <script>
            showAlert('Reservation created successfully!', 'admin_manage_reservations.php');
        </script>
    <?php elseif (isset($error_message)) : ?>
        <script>
            showAlert('<?php echo addslashes($error_message); ?>', 'admin_make_reservation.php');
        </script>
    <?php endif; ?>
