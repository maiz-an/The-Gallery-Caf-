...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['update_status'])) {
    ...
    if ($stmt->execute()) {
        ...
        echo "<script>alert('Reservation status updated successfully!'); window.location.href = 'admin_manage_reservations.php';</script>";
    } else {
...
<body>
    ...
    <main>
        <div class="table-container">
            <a href="admin_make_reservation.php" class="cart-link">Add</a>
                    ...
                    <?php if ($result->num_rows > 0) : ?>
                        <?php while ($row = $result->fetch_assoc()) : ?>
                            <tr>
                                ...
                                <td>
                                    <form action="admin_manage_reservations.php" method="post">
