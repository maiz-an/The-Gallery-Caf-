...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['update_status'])) {
    ...
    if (mysqli_query($conn, $sql)) {
        echo "<script>alert('Order status updated successfully!'); window.location.href = 'staff_manage_orders.php';</script>";
    } else {
            ...
            <div class="title-nav">
                <nav>
                    <ul>
                        ...
                        <li><a href="staff_manage_orders.php" class="nav-btn" style="color: #ffcc00;">Orders</a></li>
        ...
        <table>
            ...
            if (mysqli_num_rows($result) > 0) {
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo '<td>';
                    echo '<form method="post" action="staff_manage_orders.php">';
